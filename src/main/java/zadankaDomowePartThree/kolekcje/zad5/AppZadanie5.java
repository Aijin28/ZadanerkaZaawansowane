...
//        System.out.println(SumowaniePensji.sumaPensji(listaPracownikow));
        SzukaniePoImieniu.szukaniePoImieniu(listaPracownikow);
//        WypisaniePracownikow.wypisanieImionPracownikow(listaPracownikow);
//        System.out.println(UsuwaniePracownikow.zmniejszonaListaPracownikow(listaPracownikow, SzukaniePoImieniu.szukaniePoImieniu(listaPracownikow)));
//        listaPracownikow.remove(SzukaniePoImieniu.szukaniePoImieniu(listaPracownikow));
//        WypisaniePracownikow.wypisanieImionPracownikow(listaPracownikow);
        KontaIZarobki.mapaKontIZarobkow(listaPracownikow);
